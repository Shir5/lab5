...
remove_any_by_hair_color hairColor : удалить из коллекции один элемент, значение поля hairColor которого эквивалентно заданному
...
public class Coordinates {
    private Integer x; //Максимальное значение поля: 901, Поле не может быть null
    private long y; //Максимальное значение поля: 461
}
